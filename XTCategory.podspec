...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/XiangtaiCompany/XTCategory.git"
  ...
  s.source       = { :git => "https://github.com/XiangtaiCompany/XTCategory.git", :tag => s.version.to_s }
  ...
  s.source_files  = "XTCategory/XTCategory/**/*.{h,m}"
